...
RUN /etc/dockerbuild/BuildScript ImageExport "/tmp/dockerbuild/example1_image:2/layer 2" "2. ImageExport"
...
RUN /etc/dockerbuild/BuildScript Entrypoint.sh "/tmp/dockerbuild/example1_image:2/layer 2" "3. Entrypoint.sh"
