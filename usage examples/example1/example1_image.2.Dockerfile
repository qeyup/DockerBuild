...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# Dockerfile content autogenerated by DockerBuild v0.6.5
...
RUN /etc/dockerbuild/BuildScript ImageExport "/tmp/dockerbuild/example1_nested1/image 1" "ImageExport" False
...
RUN /etc/dockerbuild/BuildScript ImageExport "/tmp/dockerbuild/example1_nested3/image 2/image 3" "ImageExport" False
...
RUN /etc/dockerbuild/BuildScript ImageExport "/tmp/dockerbuild/example1_nested2/image 2" "ImageExport" False
...
# Build source 'layer 1/0.-BuildExport'
COPY ["layer 1/0.-BuildExport", "/tmp/dockerbuild/example1_image:2/layer 1/0.-BuildExport"]
RUN /etc/dockerbuild/BuildScript BuildExport "/tmp/dockerbuild/example1_image:2/layer 1" "0.-BuildExport" True
...
COPY ["layer 2/1. Entrypoint.sh", "/tmp/dockerbuild/example1_image:2/layer 2/1. Entrypoint.sh"]
RUN /etc/dockerbuild/BuildScript Entrypoint.sh "/tmp/dockerbuild/example1_image:2/layer 2" "1. Entrypoint.sh" True


# Build source 'layer 2/2. ImageExport'
COPY ["layer 2/2. ImageExport", "/tmp/dockerbuild/example1_image:2/layer 2/2. ImageExport"]
RUN /etc/dockerbuild/BuildScript ImageExport "/tmp/dockerbuild/example1_image:2/layer 2" "2. ImageExport" True


# Entrypoint 'layer 2/3. Entrypoint.sh'
COPY ["layer 2/3. Entrypoint.sh", "/tmp/dockerbuild/example1_image:2/layer 2/3. Entrypoint.sh"]
RUN /etc/dockerbuild/BuildScript Entrypoint.sh "/tmp/dockerbuild/example1_image:2/layer 2" "3. Entrypoint.sh" True
