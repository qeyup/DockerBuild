...
COPY ["layer 1/0.-BuildExport", "/tmp/dockerbuild/example1_image:1/layer 1/0.-BuildExport"]
RUN /etc/dockerbuild/BuildScript BuildExport "/tmp/dockerbuild/example1_image:1/layer 1" "0.-BuildExport" True
...
RUN /etc/dockerbuild/BuildScript Entrypoint.sh "/tmp/dockerbuild/example1_image:1/layer 2" "1. Entrypoint.sh" True


# Build source 'layer 2/2. ImageExport'
COPY ["layer 2/2. ImageExport", "/tmp/dockerbuild/example1_image:1/layer 2/2. ImageExport"]
RUN /etc/dockerbuild/BuildScript ImageExport "/tmp/dockerbuild/example1_image:1/layer 2" "2. ImageExport" True


# Entrypoint 'layer 2/3. Entrypoint.sh'
COPY ["layer 2/3. Entrypoint.sh", "/tmp/dockerbuild/example1_image:1/layer 2/3. Entrypoint.sh"]
RUN /etc/dockerbuild/BuildScript Entrypoint.sh "/tmp/dockerbuild/example1_image:1/layer 2" "3. Entrypoint.sh" True
