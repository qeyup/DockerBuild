...
def main(argv=sys.argv[1:]):
    ...
    for image_to_build in images_to_build:
        ...
        for image_info in image_to_build:
            ...
            version_info="\n"
            version_info+="#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n"
            version_info+="# Dockerfile content autogenerated by DockerBuild v%s\n" % version
            version_info+="# https://pypi.org/project/DockerBuild/\n"
            version_info+="#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n\n"
            docker_file_content=version_info+docker_file_content
